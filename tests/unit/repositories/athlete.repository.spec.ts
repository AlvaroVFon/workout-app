...
describe('AthleteRepository', () => {
  ...
  it('should find an athlete by ID', async () => {
    ;(Athlete.findOne as jest.Mock).mockReturnValue({
      populate: jest.fn().mockResolvedValue(mockAthlete),
    })
  ...
  it('should find all athletes by filter', async () => {
    ...
    ;(Athlete.find as jest.Mock).mockReturnValue({
      populate: jest.fn().mockResolvedValue([mockAthlete]),
    })
  ...
  it('should update an athlete', async () => {
    ...
    ;(Athlete.findOneAndUpdate as jest.Mock).mockReturnValue({
      populate: jest.fn().mockResolvedValue({ ...mockAthlete, ...updateData }),
    })
