...
describe('UserMiddleware', () => {
  ...
  describe('validateCreateUserSchemas', () => {
    it('should call next with BadRequestException if validation fails', async () => {
      ...
      ;(createUserSchema.validate as jest.Mock).mockReturnValue({ error: { details: [{ message: 'Invalid data' }] } })
  ...
  describe('validateUpdateUserSchemas', () => {
    it('should call next with BadRequestException if validation fails', async () => {
      req.body = { invalid: 'data' }
      ;(updateUserSchema.validate as jest.Mock).mockReturnValue({ error: { details: [{ message: 'Invalid data' }] } })
  ...
  describe('validateObjectId', () => {
    it('should call next with BadRequestException if validation fails', async () => {
      ...
      ;(objectIdSchema.validate as jest.Mock).mockReturnValue({ error: { details: [{ message: 'Invalid ID' }] } })

      await userMiddleware.validateObjectId(req as Request, res as Response, next)
